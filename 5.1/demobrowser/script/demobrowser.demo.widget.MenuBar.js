...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.MenuBar.10043076e898.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var b="-",c="PageUp",d="Escape",f="Boolean",g="+",h="qx.event.type.Data",j="_applyShortcut",k="PrintScreen",l="NumLock",m="short",n="keydown",o="5",p="8",q="execute",r="Meta",s="0",t="",u="2",v="Control",w="Shift",x="You can only specify one non modifier key!",y="3",z="Unidentified",A="/",B="Delete",C="String",D="changeEnabled",E="*",F="qx.bom.Shortcut",G="6",H="4",I="1",J="Alt",K="Not a valid key name for a shortcut: ",L="PageDown",M="Whitespaces are not allowed within shortcuts",N="_applyEnabled",O="keypress",P="7",Q="a",R="z",S="9";qx.Class.define(F,{extend:qx.core.Object,construct:function(T){qx.core.Object.call(this);this.__Ea={};this.__Eb=null;if(T!=null){this.setShortcut(T);}
;this.initEnabled();}
,events:{"execute":h},properties:{enabled:{init:true,check:f,event:D,apply:N},shortcut:{check:C,apply:j,nullable:true},autoRepeat:{check:f,init:false}},members:{__Ea:t,__Eb:t,execute:function(U){this.fireDataEvent(q,U);}
,__Ec:function(event){if(this.getEnabled()&&this.__Ed(event)){if(!this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,__hV:function(event){if(this.getEnabled()&&this.__Ed(event)){if(this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,_applyEnabled:function(W,V){if(W){qx.event.Registration.addListener(document.documentElement,n,this.__Ec,this);qx.event.Registration.addListener(document.documentElement,O,this.__hV,this);}
else {qx.event.Registration.removeListener(document.documentElement,n,this.__Ec,this);qx.event.Registration.removeListener(document.documentElement,O,this.__hV,this);}
;}
,_applyShortcut:function(bb,Y){if(bb){if(bb.search(/[\s]+/)!=-1){var bc=M;this.error(bc);throw new Error(bc);}
;this.__Ea={"Control":false,"Shift":false,"Meta":false,"Alt":false};this.__Eb=null;var X;var a=[];while(bb.length>0&&X!=-1){X=bb.search(/[-+]+/);a.push((bb.length==1||X==-1)?bb:bb.substring(0,X));bb=bb.substring(X+1);}
;var ba=a.length;for(var i=0;i<ba;i++ ){var bd=this.__Ef(a[i]);switch(bd){case v:case w:case r:case J:this.__Ea[bd]=true;break;case z:var bc=K+a[i];this.error(bc);throw bc;default:if(this.__Eb){var bc=x;this.error(bc);throw bc;}
;this.__Eb=bd;};}
;}
;return true;}
,__Ed:function(e){var be=this.__Eb;if(!be){return false;}
;if((!this.__Ea.Shift&&e.isShiftPressed())||(this.__Ea.Shift&&!e.isShiftPressed())||(!this.__Ea.Control&&e.isCtrlPressed())||(this.__Ea.Control&&!e.isCtrlPressed())||(!this.__Ea.Meta&&e.isMetaPressed())||(this.__Ea.Meta&&!e.isMetaPressed())||(!this.__Ea.Alt&&e.isAltPressed())||(this.__Ea.Alt&&!e.isAltPressed())){return false;}
;if(be==e.getKeyIdentifier()){return true;}
;return false;}
,__Ee:{esc:d,ctrl:v,print:k,del:B,pageup:c,pagedown:L,numlock:l,numpad_0:s,numpad_1:I,numpad_2:u,numpad_3:y,numpad_4:H,numpad_5:o,numpad_6:G,numpad_7:P,numpad_8:p,numpad_9:S,numpad_divide:A,numpad_multiply:E,numpad_minus:b,numpad_plus:g},__Ef:function(bg){var bf=qx.event.util.Keyboard;var bh=z;if(bf.isValidKeyIdentifier(bg)){return bg;}
;if(bg.length==1&&bg>=Q&&bg<=R){return bg.toUpperCase();}
;bg=bg.toLowerCase();var bh=this.__Ee[bg]||qx.lang.String.firstUp(bg);if(bf.isValidKeyIdentifier(bh)){return bh;}
else {return z;}
;}
,toString:function(){var bj=this.__Eb;var bk=[];for(var bi in this.__Ea){if(this.__Ea[bi]){bk.push(qx.locale.Key.getKeyName(m,bi));}
;}
;if(bj){bk.push(qx.locale.Key.getKeyName(m,bj));}
;return bk.join(g);}
},destruct:function(){this.setEnabled(false);this.__Ea=this.__Eb=null;}
});}
)();
...
;var P=K.getMarginLeft()+K.getMarginRight();P=Math.max(P,this.getSpacing());var J=K.getSizeHint().width+P;this.__tv(K);G-=J;if(E&&E.getVisibility()!=o){E.setVisibility(o);G+=L;var H=E.getMarginLeft()+E.getMarginRight();G+=Math.max(H,this.getSpacing());}
;}
while(G>F);}
else if(this.__ts.length>0){do {var Q=this.__ts[0];if(Q){var P=Q.getMarginLeft()+Q.getMarginRight();P=Math.max(P,this.getSpacing());if(Q.getContentElement().getDomElement()==null){Q.syncAppearance();Q.invalidateLayoutCache();}
;var I=Q.getSizeHint().width;var O=false;if(this.__ts.length==1&&L>0){var N=P-this.getSpacing();var M=G-L+I+N;O=F>M;}
;if(F>G+I+P||O){this.__tu(Q);G+=I;if(E&&this.__ts.length==0){E.setVisibility(y);}
;}
else {return;}
;}
;}
while(F>=G&&this.__ts.length>0);}
;}
,__tu:function(R){R.setVisibility(o);this.__ts.shift();this.fireDataEvent(m,R);}
,__tv:function(S){if(!S){return;}
;this.__ts.unshift(S);S.setVisibility(y);this.fireDataEvent(A,S);}
,_getNextToHide:function(){for(var i=this.__tt.length-1;i>=0;i-- ){var T=this.__tt[i];if(T&&T.getVisibility&&T.getVisibility()==o){return T;}
;}
...
;}
;}
,setRemovePriority:function(X,W,Y){if(!Y&&this.__tt[W]!=undefined){throw new Error(v);}
;this.__tt[W]=X;}
...
;for(var i=0;i<this.__ts.length;i++ ){this.__ts[i].setVisibility(o);}
;this.__ts=[];}
;}
...
;bf.setVisibility(y);}
;}
,__tw:false,_setAllowMenuOpenHover:function(bg){this.__tw=bg;}
,_isAllowMenuOpenHover:function(){return this.__tw;}
...
(function(){var a="blur",b="Enter",c="__ls",d="Escape",f="Space",g="keydown",h="Left",j="Down",k="Up",l="singleton",m="qx.debug",n="interval",o="roll",p="__td",q="event.touch",r="Object is no menu: ",s="pointerdown",t="qx.ui.menu.Manager",u="keyup",v="keypress",w="contextmenu",x="__tc",y="Right";qx.Class.define(t,{type:l,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__ls=[];var z=document.body;var A=qx.event.Registration;A.addListener(window.document.documentElement,s,this._onPointerDown,this,true);A.addListener(z,o,this._onRoll,this,true);A.addListener(z,g,this._onKeyUpDown,this,true);A.addListener(z,u,this._onKeyUpDown,this,true);A.addListener(z,v,this._onKeyPress,this,true);if(!qx.core.Environment.get(q)){qx.bom.Element.addListener(window,a,this.hideAll,this);}
;this.__tc=new qx.event.Timer();this.__tc.addListener(n,this._onOpenInterval,this);this.__td=new qx.event.Timer();this.__td.addListener(n,this._onCloseInterval,this);}
,members:{__te:null,__tf:null,__tc:null,__td:null,__ls:null,_getChild:function(B,D,C,G){var F=B.getChildren();var length=F.length;var E;for(var i=D;i<length&&i>=0;i+=C){E=F[i];if(E.isEnabled()&&!E.isAnonymous()&&E.isVisible()){return E;}
;}
...
;H=H.getLayoutParent();}
;return false;}
,_isMenuOpener:function(J){var I=this.__ls;for(var i=0;i<I.length;i++ ){if(I[i].getOpener()===J){return true;}
;}
;return false;}
...
;}
;var M=this.__ls;M.push(L);L.setZIndex(1e6+M.length);}
,remove:function(N){if(qx.core.Environment.get(m)){if(!(N instanceof qx.ui.menu.Menu)){throw new Error(r+N);}
;}
;var O=this.__ls;if(O){qx.lang.Array.remove(O,N);}
;}
,hideAll:function(){var P=this.__ls;if(P){for(var i=P.length-1;i>=0;i-- ){P[i].exclude();}
;}
;}
,getActiveMenu:function(){var Q=this.__ls;return Q.length>0?Q[Q.length-1]:null;}
,scheduleOpen:function(R){this.cancelClose(R);if(R.isVisible()){if(this.__te){this.cancelOpen(this.__te);}
;}
else if(this.__te!=R){this.__te=R;this.__tc.restartWith(R.getOpenInterval());}
;}
,scheduleClose:function(S){this.cancelOpen(S);if(!S.isVisible()){if(this.__tf){this.cancelClose(this.__tf);}
;}
else if(this.__tf!=S){this.__tf=S;this.__td.restartWith(S.getCloseInterval());}
;}
,cancelOpen:function(T){if(this.__te==T){this.__tc.stop();this.__te=null;}
;}
,cancelClose:function(U){if(this.__tf==U){this.__td.stop();this.__tf=null;}
;}
,_onOpenInterval:function(e){this.__tc.stop();this.__te.open();this.__te=null;}
,_onCloseInterval:function(e){this.__td.stop();this.__tf.exclude();this.__tf=null;}
,preventContextMenuOnce:function(){qx.event.Registration.addListener(document.body,w,this.__tg,this,true);}
,__tg:function(e){var V=e.getTarget();V=qx.ui.core.Widget.getWidgetByElement(V,true);if(this._isInMenu(V)){e.stopPropagation();e.preventDefault();}
;qx.event.Registration.removeListener(document.body,w,this.__tg,this,true);}
...
;if(this.__ls.length>0&&!this._isInMenu(W)){this.hideAll();}
;}
,__th:{"Enter":1,"Space":1},__ps:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var X=this.getActiveMenu();if(!X){return;}
;var Y=e.getKeyIdentifier();if(this.__ps[Y]||(this.__th[Y]&&X.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var bc=this.getActiveMenu();if(!bc){return;}
;var ba=e.getKeyIdentifier();var be=this.__ps[ba];var bb=this.__th[ba];if(be){switch(ba){case k:this._onKeyPressUp(bc);break;case j:this._onKeyPressDown(bc);break;case h:this._onKeyPressLeft(bc);break;case y:this._onKeyPressRight(bc);break;case d:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
else if(bb){var bd=bc.getSelectedButton();if(bd){switch(ba){case b:this._onKeyPressEnter(bc,bd,e);break;case f:this._onKeyPressSpace(bc,bd,e);break;};e.stopPropagation();e.preventDefault();}
;}
;}
...
;}
;}
,_onKeyPressEnter:function(bE,bF,e){if(bF.hasListener(v)){var bG=e.clone();bG.setBubbles(false);bG.setTarget(bF);bF.dispatchEvent(bG);}
;this.hideAll();}
,_onKeyPressSpace:function(bH,bI,e){if(bI.hasListener(v)){var bJ=e.clone();bJ.setBubbles(false);bJ.setTarget(bI);bI.dispatchEvent(bJ);}
;}
,_onRoll:function(e){var bK=e.getTarget();bK=qx.ui.core.Widget.getWidgetByElement(bK,true);if(this.__ls.length>0&&!this._isInMenu(bK)&&!this._isMenuOpener(bK)&&!e.getMomentum()){this.hideAll();}
;}
},destruct:function(){var bM=qx.event.Registration;var bL=document.body;bM.removeListener(window.document.documentElement,s,this._onPointerDown,this,true);bM.removeListener(bL,g,this._onKeyUpDown,this,true);bM.removeListener(bL,u,this._onKeyUpDown,this,true);bM.removeListener(bL,v,this._onKeyPress,this,true);this._disposeObjects(x,p);this._disposeArray(c);}
});}
)();
...
;this.__tk();}
,__tk:function(){if(this.isVisible()){if(this.getBlockBackground()){var V=this.getZIndex();this._blocker.blockContent(V-1);}
;}
...
,__tl:function(){var bn=this._getMenuBounds();if(!bn){this.addListenerOnce(n,this.__tl,this);return;}
...
;this.__tj=bp;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bq){this.getChildControl(h);if(this.__tj){this.__tj.call(this);delete this.__tj;}
;}
...
;this.__tl();}
;}
,_onPointerOver:function(e){var bt=qx.ui.menu.Manager.getInstance();bt.cancelClose(this);var bu=e.getTarget();if(bu.isEnabled()&&bu instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(bu);var bs=bu.getMenu&&bu.getMenu();if(bs){bs.setOpener(bu);bt.scheduleOpen(bs);this.__ti=bs;}
else {var bv=this.getOpenedButton();if(bv){bt.scheduleClose(bv.getMenu());}
;if(this.__ti){bt.cancelOpen(this.__ti);this.__ti=null;}
;}
;}
...
;if(this.__ti){bw.cancelOpen(this.__ti);}
;}
;}
...
(function(){var a="qx.ui.menu.Layout",b="Integer",c="_applyLayoutChange";qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:b,init:0,apply:c},spanColumn:{check:b,init:1,nullable:true,apply:c},iconColumnWidth:{check:b,init:0,themeable:true,apply:c},arrowColumnWidth:{check:b,init:0,themeable:true,apply:c}},members:{__tm:null,_computeSizeHint:function(){var q=this._getLayoutChildren();var o,g,k;var e=this.getSpanColumn();var j=this.__tm=[0,0,0,0];var n=this.getColumnSpacing();var m=0;var f=0;for(var i=0,l=q.length;i<l;i++ ){o=q[i];if(o.isAnonymous()){continue;}
...
,getColumnSizes:function(){return this.__tm||null;}
...
;var x=this.__tn(y[0]);var w=x.getColumnSizes();var s=x.getSpacingX();var z=qx.lang.Array.sum(w)+s*(w.length-1);if(z<o){w[1]+=o-z;}
...
;}
;}
,__tn:function(B){while(!(B instanceof qx.ui.menu.Menu)){B=B.getLayoutParent();}
;return B;}
...
,__tx:function(){var y=this.getChildrenContainer().getChildren();y=y.filter(function(z){return z.getVisibility()==k;}
