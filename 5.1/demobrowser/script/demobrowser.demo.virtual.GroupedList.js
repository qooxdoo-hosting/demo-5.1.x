...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.GroupedList.b2cbf1d6e976.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
};T.setDelegate(V);T.setSelection(this.__Il.getSelection());return U;}
,createThirdExample:function(){var bc=new qx.ui.container.Composite(new qx.ui.layout.Canvas());var be=new qx.ui.basic.Label(u).set({font:v});bc.add(be);var bb=this.__OG=new qx.ui.list.List().set({height:280,width:150,labelPath:e,labelOptions:{converter:function(bg,bf){return bf?bg+D+bf.getLastname():B;}
...
};bb.setDelegate(bd);bb.setSelection(this.__Il.getSelection());return bc;}
},destruct:function(){this.__Il.dispose();this.__OF.dispose();this.__OG.dispose();this.__Il=this.__OF=this.__OG=null;}
});}
)();
...
(function(){var a="scrollY",b="The method 'getItemRight' is not implemented!",c="update",d="scrollX",f="The method 'getItemLeft' is not implemented!",g="The method 'getItemBottom' is not implemented!",h="The method 'getItemTop' is not implemented!",i="pane",j="os.scrollBarOverlayed",k="qx.ui.virtual.core.Scroller";qx.Class.define(k,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(o,l,n,m){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__xQ=new qx.ui.virtual.core.Pane(o,l,n,m);this.__xQ.addListener(c,this._computeScrollbars,this);this.__xQ.addListener(d,this._onScrollPaneX,this);this.__xQ.addListener(a,this._onScrollPaneY,this);if(qx.core.Environment.get(j)){this._add(this.__xQ,{edge:0});}
else {this._add(this.__xQ,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__xQ:null,getPane:function(){return this.__xQ;}
,_createChildControlImpl:function(q,p){if(q==i){return this.__xQ;}
...
,_onScrollBarX:function(e){this.__xQ.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__xQ.setScrollY(e.getData());}
},destruct:function(){this.__xQ.dispose();this.__xQ=null;}
});}
)();
(function(){var a="scrollY",b="__xW",c="__xS",d="cellTap",f="qx.event.type.Data",g="change",h="qx.debug",j="qx.event.type.Event",k="cellContextmenu",l="dbltap",m="resize",n="cellDbltap",o="scrollX",p="tap",q="appear",r="pointerdown",s="__xR",t="qx.ui.virtual.core.Pane",u="qx.ui.virtual.core.CellEvent",v="update",w="contextmenu",x="__xX";qx.Class.define(t,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__xR=new qx.ui.virtual.core.Axis(A,B);this.__xS=new qx.ui.virtual.core.Axis(z,y);this.__pH=0;this.__pG=0;this.__xT=0;this.__xU=0;this.__xV={};this.__jj={};this.__xW=new qx.ui.container.Composite();this.__xW.setUserBounds(0,0,0,0);this._add(this.__xW);this.__xX=[];this.__xR.addListener(g,this.fullUpdate,this);this.__xS.addListener(g,this.fullUpdate,this);this.addListener(m,this._onResize,this);this.addListenerOnce(q,this._onAppear,this);this.addListener(r,this._onPointerDown,this);this.addListener(p,this._onTap,this);this.addListener(l,this._onDbltap,this);this.addListener(w,this._onContextmenu,this);}
,events:{cellTap:u,cellContextmenu:u,cellDbltap:u,update:j,scrollX:f,scrollY:f},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__xR:null,__xS:null,__pH:null,__pG:null,__xT:null,__xU:null,__xV:null,__jj:null,__xW:null,__xX:null,__xY:null,__tm:null,__ur:null,__ya:null,getRowConfig:function(){return this.__xR;}
,getColumnConfig:function(){return this.__xS;}
,getChildren:function(){return [this.__xW];}
,addLayer:function(C){if(qx.core.Environment.get(h)){this.assertInterface(C,qx.ui.virtual.core.ILayer);}
;this.__xX.push(C);C.setUserBounds(0,0,0,0);this.__xW.add(C);}
,getLayers:function(){return this.__xX;}
,getVisibleLayers:function(){var D=[];for(var i=0;i<this.__xX.length;i++ ){var E=this.__xX[i];if(E.isVisible()){D.push(E);}
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__xS.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__xR.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(J){var H=this.getScrollMaxY();if(J<0){J=0;}
else if(J>H){J=H;}
;if(this.__pH!==J){var I=this.__pH;this.__pH=J;this._deferredUpdateScrollPosition();this.fireDataEvent(a,J,I);}
;}
,getScrollY:function(){return this.__pH;}
,setScrollX:function(M){var K=this.getScrollMaxX();if(M<0){M=0;}
else if(M>K){M=K;}
;if(M!==this.__pG){var L=this.__pG;this.__pG=M;this._deferredUpdateScrollPosition();this.fireDataEvent(o,M,L);}
;}
,getScrollX:function(){return this.__pG;}
,getScrollSize:function(){return {width:this.__xS.getTotalSize(),height:this.__xR.getTotalSize()};}
...
,this,0);}
,this);return;}
;var R=this.__xR.getItemPosition(P);var O=R+this.__xR.getItemSize(P);var N=this.getScrollY();if(R<N){this.setScrollY(R);}
...
,this,0);}
,this);return;}
;var U=this.__xS.getItemPosition(S);var T=U+this.__xS.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
...
;bf=this.__xR.getItemAtPosition(this.getScrollY()+bc-bd.top);be=this.__xS.getItemAtPosition(this.getScrollX()+bb-bd.left);if(!bf||!be){return null;}
...
;var bn=this.__pG+bl.width;var bo=this.__xU-bn;if(this.__pG-this.__xV.left<Math.min(this.__pG,bj)||this.__xV.right-bn<Math.min(bo,bk)){var bp=Math.min(this.__pG,bm);var bh=Math.min(bo,bi);this._setLayerWindow(bg,this.__pG-bp,this.__pH,bl.width+bp+bh,bl.height,false);}
;}
,prefetchY:function(bz,bv,br,bu){var bq=this.getVisibleLayers();if(bq.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bs=this.__pH+bw.height;var bt=this.__xT-bs;if(this.__pH-this.__xV.top<Math.min(this.__pH,bz)||this.__xV.bottom-bs<Math.min(bt,br)){var by=Math.min(this.__pH,bv);var bx=Math.min(bt,bu);this._setLayerWindow(bq,this.__pG,this.__pH-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContentElement().getDomElement()){this.__xY=true;this._updateScrollPosition();this.__xY=null;this.fireEvent(v);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onPointerDown:function(e){this.__ya=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onTap:function(e){this.__yb(e,d);}
,_onContextmenu:function(e){this.__yb(e,k);}
,_onDbltap:function(e){this.__yb(e,n);}
,__yb:function(e,bC){var bB=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bB){return;}
;var bA=this.__ya;if(bA==null||bA.row!==bB.row||bA.column!==bB.column){return;}
;this.fireNonBubblingEvent(bC,qx.ui.virtual.core.CellEvent,[this,e,bB.row,bB.column]);}
,syncWidget:function(bD){if(this.__jj._fullUpdate){this._fullUpdate();}
else if(this.__jj._updateScrollPosition){this._updateScrollPosition();}
;this.__jj={};}
,_setLayerWindow:function(bE,bT,top,bP,bL,bV){var bK=this.__xR.getItemAtPosition(top);if(bK){var bN=bK.index;var bR=this.__xR.getItemSizes(bN,bL+bK.offset);var bM=qx.lang.Array.sum(bR);var bU=top-bK.offset;var bQ=top-bK.offset+bM;}
else {var bN=0;var bR=[];var bM=0;var bU=0;var bQ=0;}
;var bF=this.__xS.getItemAtPosition(bT);if(bF){var bJ=bF.index;var bH=this.__xS.getItemSizes(bJ,bP+bF.offset);var bO=qx.lang.Array.sum(bH);var bS=bT-bF.offset;var bI=bT-bF.offset+bO;}
else {var bJ=0;var bH=[];var bO=0;var bS=0;var bI=0;}
;this.__xV={top:bU,bottom:bQ,left:bS,right:bI};this.__xW.setUserBounds((this.getPaddingLeft()||0)+(this.__xV.left-this.__pG),(this.getPaddingTop()||0)+(this.__xV.top-this.__pH),bO,bM);this.__tm=bH;this.__ur=bR;for(var i=0;i<this.__xX.length;i++ ){var bG=this.__xX[i];bG.setUserBounds(0,0,bO,bM);if(bV){bG.fullUpdate(bN,bJ,bR,bH);}
else {bG.updateLayerWindow(bN,bJ,bR,bH);}
;}
;}
,__yc:function(){if(this.__xY){return;}
;var bW=this.getScrollSize();if(this.__xT!==bW.height||this.__xU!==bW.width){this.__xT=bW.height;this.__xU=bW.width;this.fireEvent(v);}
;}
...
,_fullUpdate:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__yc();return;}
;var bY=this.getBounds();if(!bY){return;}
;this._setLayerWindow(bX,this.__pG,this.__pH,bY.width,bY.height,true);this.__yc();}
,_deferredUpdateScrollPosition:function(){this.__jj._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__yc();return;}
;var cc=this.getBounds();if(!cc){return;}
;var cb={top:this.__pH,bottom:this.__pH+cc.height,left:this.__pG,right:this.__pG+cc.width};if(this.__xV.top<=cb.top&&this.__xV.bottom>=cb.bottom&&this.__xV.left<=cb.left&&this.__xV.right>=cb.right){this.__xW.setUserBounds((this.getPaddingLeft()||0)+(this.__xV.left-cb.left),(this.getPaddingTop()||0)+(this.__xV.top-cb.top),this.__xV.right-this.__xV.left,this.__xV.bottom-this.__xV.top);}
else {this._setLayerWindow(ca,this.__pG,this.__pH,cc.width,cc.height,false);}
;this.__yc();}
},destruct:function(){this._disposeArray(x);this._disposeObjects(s,c,b);this.__xV=this.__jj=this.__tm=this.__ur=null;}
});}
)();
...
,events:{"change":e},members:{__yd:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__yd=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__yd=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__yd=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__yd=null;this.fireNonBubblingEvent(c);}
,__ye:function(){if(this.__yd){return this.__yd;}
;var s=this.defaultItemSize;var q=this.itemCount;var y=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<q){y.push(p);}
;}
;if(y.length==0){var u=[{startIndex:0,endIndex:q-1,firstItemSize:s,rangeStart:0,rangeEnd:q*s-1}];this.__yd=u;return u;}
...
;var z=u[u.length-1];var w=(q-z.startIndex-1)*s;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=q-1;this.__yd=u;return u;}
,__yf:function(F){var B=this.__yd||this.__ye();var C=0;var A=B.length-1;while(true){var E=C+((A-C)>>1);var D=B[E];if(D.rangeEnd<F){C=E+1;}
else if(D.rangeStart>F){A=E-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(K){if(K<0||K>=this.getTotalSize()){return null;}
;var J=this.__yf(K);var L=J.rangeStart;var G=J.startIndex;var I=J.firstItemSize;if(L+I>K){return {index:G,offset:K-L};}
else {var H=this.defaultItemSize;return {index:G+1+Math.floor((K-L-I)/H),offset:(K-L-I)%H};}
;}
,__yg:function(M){var O=this.__yd||this.__ye();var P=0;var N=O.length-1;while(true){var R=P+((N-P)>>1);var Q=O[R];if(Q.endIndex<M){P=R+1;}
else if(Q.startIndex>M){N=R-1;}
else {return Q;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__yg(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__yd||this.__ye();return U[U.length-1].rangeEnd+1;}
...
;}
;return W;}
},destruct:function(){this.customSizes=this.__yd=null;}
});}
)();
...
,properties:{selection:{check:d,event:n,apply:h,nullable:false,deferredInit:true},selectionMode:{check:[l,f,p,a],init:l,apply:o},dragSelection:{check:b,init:false,apply:k},quickSelection:{check:b,init:false,apply:m}},events:{"changeSelection":q},members:{_manager:null,__yh:false,__yi:false,__xG:null,_initSelectionManager:function(){var self=this;var r={isItemSelectable:function(s){return self._provider.isSelectable(s);}
...
,_onChangeSelection:function(e){if(this.__yi==true){return;}
;this.__yh=true;var G=this.getSelection();var I=[];for(var i=0;i<G.getLength();i++ ){var H=G.getItem(i);var J=this._getSelectables();var F=-1;if(J!=null){F=J.indexOf(H);}
...
;this.__yh=false;}
,_onManagerChangeSelection:function(e){if(this.__yh==true){return;}
;this.__yi=true;this.__xL();this.__yi=false;}
,__xL:function(){if(this.__yk()){return;}
;var M=this._manager.getSelection();var N=[];for(var i=0;i<M.length;i++ ){var O=this._getDataFromRow(M[i]);if(O!=null){N.push(O);}
;}
;this.__yj(N);}
,__yj:function(R){var Q=this.getSelection();if(R.length>0){var P=[0,Q.getLength()];P=P.concat(R);var S=Q.splice.apply(Q,P);S.dispose();}
else {Q.removeAll();}
;}
,__yk:function(){var U=this.getSelection();var W=this._manager.getSelection();if(U.getLength()!==W.length){return false;}
...
,_init:function(){this._provider=new qx.ui.list.provider.WidgetProvider(this);this.__ym=[];this.__yn=[];this.__yo={};this.__yp=false;this.__yq=false;this.__yr=false;this.getPane().addListener(d,this._onResize,this);this._initBackground();this._initLayer();}
...
;}
,_getLookupTable:function(){return this.__ym;}
,_lookup:function(Q){return this.__ym[Q];}
,_lookupGroup:function(R){return this.__yn.indexOf(R);}
,_reverseLookup:function(S){if(S<0){return -1;}
;return this.__ym.indexOf(S);}
...
,_applyGroupRowHeight:function(ba,Y){this.__yt();}
...
,_applyDelegate:function(bo,bn){this._provider.setDelegate(bo);this.__yu();}
,_onResize:function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);}
,_onModelChange:function(e){this.__yu();this._applyDefaultSelection();}
,__ys:function(){this.getPane().getRowConfig().setItemCount(this.__ym.length);this.getPane().fullUpdate();}
,__yt:function(){var bp=this.getPane().getRowConfig();var bq=this.getGroupItemHeight();bp.resetItemSizes();if(bq){for(var i=0,l=this.__ym.length;i<l; ++i){if(this.__ym[i]==-1){bp.setItemSize(i,bq);}
;}
;}
;}
,__yu:function(){this.__ym=[];this.__yn=[];this.__yo={};if(this.isAutoGrouping()){this.getGroups().removeAll();}
;var br=this.getModel();if(br!=null){this._runDelegateFilter(br);this._runDelegateSorter(br);this._runDelegateGroup(br);}
;this._updateSelection();this.__yt();this.__ys();}
,_runDelegateFilter:function(bt){var bs=qx.util.Delegate.getMethod(this.getDelegate(),D);for(var i=0,l=bt.length;i<l; ++i){if(bs==null||bs(bt.getItem(i))){this.__ym.push(i);}
;}
;}
,_runDelegateSorter:function(bu){if(this.__ym.length==0){return;}
;var bv=qx.util.Delegate.getMethod(this.getDelegate(),t);if(bv!=null){this.__ym.sort(function(a,b){return bv(bu.getItem(a),bu.getItem(b));}
);}
;}
,_runDelegateGroup:function(bz){var bA=qx.util.Delegate.getMethod(this.getDelegate(),v);if(bA!=null){for(var i=0,l=this.__ym.length;i<l; ++i){var bw=this.__ym[i];var by=this.getModel().getItem(bw);var bx=bA(by);this.__yv(bx,bw);}
;this.__ym=this.__yw();}
;}
,__yv:function(bC,bB){if(bC==null){this.__yr=true;bC=A;}
;var name=this.__yx(bC);if(this.__yo[name]==null){this.__yo[name]=[];if(this.isAutoGrouping()){this.getGroups().push(bC);}
;}
;this.__yo[name].push(bB);}
,__yw:function(){this.__yy();var bG=[];var bI=0;var bE=this.getGroups();for(var i=0;i<bE.getLength();i++ ){var bD=bE.getItem(i);bG.push(-1);this.__yn.push(bI);bI++ ;var bH=this.__yx(bD);var bF=this.__yo[bH];if(bF!=null){for(var k=0;k<bF.length;k++ ){bG.push(bF[k]);bI++ ;}
;}
;}
;return bG;}
,__yx:function(bK){var name=null;if(!qx.lang.Type.isString(bK)){var bJ=this.getGroups().indexOf(bK);this.__yq=true;name=v;if(bJ==-1){name+=this.getGroups().getLength();}
else {name+=bJ;}
;}
else {this.__yp=true;var name=bK;}
;return name;}
,__yy:function(){if(this.__yq&&this.__yr||this.__yq&&this.__yp){throw new Error(r+z);}
;}
...
;this._background.dispose();this._provider.dispose();this._layer.dispose();this._background=this._provider=this._layer=this.__ym=this.__yn=this.__yo=null;if(this.__yl){this.__yl.dispose();}
;}
});}
)();
...
,properties:{anonymous:{refine:true,init:true}},members:{__jj:null,__bN:null,__up:null,__uq:null,__ur:null,__tm:null,getFirstRow:function(){return this.__up;}
,getFirstColumn:function(){return this.__uq;}
,getRowSizes:function(){return this.__ur||[];}
,getColumnSizes:function(){return this.__tm||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__jj.fullUpdate||this.__jj.updateLayerWindow&&this.__jj.updateLayerData){this._fullUpdate.apply(this,this.__bN);}
else if(this.__jj.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bN);}
else if(this.__jj.updateLayerData&&this.__ur){this._updateLayerData();}
;if(this.__jj.fullUpdate||this.__jj.updateLayerWindow){var d=this.__bN;this.__up=d[0];this.__uq=d[1];this.__ur=d[2];this.__tm=d[3];}
;this.__jj={};}
,_updateLayerData:function(){this._fullUpdate(this.__up,this.__uq,this.__ur,this.__tm);}
...
,fullUpdate:function(p,q,o,n){this.__bN=arguments;this.__jj.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bN=arguments;this.__jj.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__jj=this.__bN=this.__ur=this.__tm=null;}
});}
)();
...
;this.__yz={};this.__yA={};}
,properties:{colorEven:{nullable:true,check:c,apply:b,themeable:true},colorOdd:{nullable:true,check:c,apply:a,themeable:true}},members:{__yB:null,__yC:null,__yz:null,__yA:null,setColor:function(h,g){if(g){this.__yz[h]=qx.theme.manager.Color.getInstance().resolve(g);}
else {delete (this.__yz[h]);}
;}
,clearCustomColors:function(){this.__yz={};this.updateLayerData();}
,getColor:function(i){var j=this.__yz[i];if(j){return j;}
else {return i%2==0?this.__yB:this.__yC;}
;}
,_applyColorEven:function(l,k){if(l){this.__yB=qx.theme.manager.Color.getInstance().resolve(l);}
else {this.__yB=null;}
;this.updateLayerData();}
,_applyColorOdd:function(n,m){if(n){this.__yC=qx.theme.manager.Color.getInstance().resolve(n);}
else {this.__yC=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__yA[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__yA[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__yA[q];}
},destruct:function(){this.__yz=this.__yA=null;}
});}
)();
...
;}
,setColor:function(J,I){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,I);if(this.__yD(J)){this.updateLayerData();}
;}
,setBackground:function(K,L){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,K,L);if(this.__yD(K)){this.updateLayerData();}
;}
,__yD:function(M){var O=this.getFirstRow();var N=O+this.getRowSizes().length-1;return M>=O&&M<=N;}
}});}
)();
...
(function(){var a="cell.type",b="model[",c="groups[",d="model",f="",g="changeDelegate",h="label",i="qx.ui.list.core.MWidgetController",j="icon",k="]",l="value",m="BindingIds",n=".",o="group",p="String";qx.Mixin.define(i,{construct:function(){this.__xx=[];}
...
;}
,bindProperty:function(u,x,v,t,s){var y=t.getUserData(a);var w=this.__xy(s,u,y);if(v){v.ignoreConverter=d;}
;var z=this._list.bind(w,t,x,v);this.__xz(t,z);}
,bindPropertyReverse:function(D,B,E,F,A){var G=F.getUserData(a);var C=this.__xy(A,D,G);var H=F.bind(B,this._list,C,E);this.__xz(F,H);}
,removeBindings:function(){while(this.__xx.length>0){var I=this.__xx.pop();this._removeBindingsFrom(I);}
;}
...
;}
,_removeBindingsFrom:function(T){var U=this.__xA(T);while(U.length>0){var V=U.pop();try{this._list.removeBinding(V);}
catch(e){T.removeBinding(V);}
;}
;if(qx.lang.Array.contains(this.__xx,T)){qx.lang.Array.remove(this.__xx,T);}
;}
,__xy:function(X,ba,Y){var W=b+X+k;if(Y==o){W=c+X+k;}
;if(ba!=null&&ba!=f){W+=n+ba;}
;return W;}
,__xz:function(bc,bd){var bb=this.__xA(bc);if(!qx.lang.Array.contains(bb,bd)){bb.push(bd);}
;if(!qx.lang.Array.contains(this.__xx,bc)){this.__xx.push(bc);}
;}
,__xA:function(be){var bf=be.getUserData(m);if(bf==null){bf=[];be.setUserData(m,bf);}
;return bf;}
...
,styleSelectabled:function(v){var u=this.__xB(v);this._styleSelectabled(u);}
,styleUnselectabled:function(x){var w=this.__xB(x);this._styleUnselectabled(w);}
...
;}
,_styleSelectabled:function(A){this.__xC(A,{selected:1});}
,_styleUnselectabled:function(B){this.__xC(B,{});}
...
,__xB:function(G){return this._list._layer.getRenderedCellWidget(G,0);}
,__xC:function(I,H){if(I==null){return;}
...
;this._cellProvider=h;this.__xD=[];}
,properties:{anonymous:{refine:true,init:false}},events:{updated:c},members:{__xD:null,getRenderedCellWidget:function(q,n){if(this._getChildren().length===0){return null;}
...
;}
,_getSpacer:function(){var r=this.__xD.pop();if(!r){r=new qx.ui.core.Spacer();r.setUserData(g,1);}
;return r;}
...
;}
;}
,_fullUpdate:function(B,v,A,z){var C=this._cellProvider;var H=this._getChildren().concat();for(var i=0;i<H.length;i++ ){var F=H[i];if(F.getUserData(g)){this.__xD.push(F);}
...
;}
;}
;var L=this._cellProvider;var P=this._getChildren().concat();for(var i=0;i<P.length;i++ ){if(!bb[i]){var W=P[i];if(W.getUserData(g)){this.__xD.push(W);}
...
;this._cellProvider=this.__xD=null;}
});}
)();
...
;}
;j.setUserData(c,h);}
,getCellWidget:function(o,m){var n=this.__xE();this.updateStates(n,m);this.updateData(n,o);return n;}
,pool:function(p){this.__cO.push(p);}
,_cleanupPool:function(){var q=this.__cO.pop();while(q){q.destroy();q=this.__cO.pop();}
;}
,__xE:function(){var r=this.__cO.shift();if(r==null){r=this._createWidget();this.fireDataEvent(a,r);}
;return r;}
