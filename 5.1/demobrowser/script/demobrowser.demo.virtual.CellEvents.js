...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents.ca4a80defd9a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_onCellTap:function(e){var q=f+e.getRow()+i+e.getColumn()+h;this.__OA(q);}
,_onContextMenu:function(e){var r=d+e.getRow()+i+e.getColumn()+h;this.__OA(r);}
,_onDbltapPane:function(e){var s=g+e.getRow()+i+e.getColumn()+h;this.__OA(s);}
,__OA:function(t){this.logger.setHtml(this.logger.getHtml()+t);}
