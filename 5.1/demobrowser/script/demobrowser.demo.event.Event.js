...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event.ff408427951c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__NJ=f+p.join(c)+a;this.__NK=o||50;this.__NL=n;this._clearLog();}
,_clearLog:function(){this.__NL.innerHTML=this.__NJ+k;this.__NM=[];}
,_log:function(q){this.__NM.unshift(q);this.__NM=this.__NM.slice(0,this.__NK);var r=[this.__NJ];for(var i=0;i<this.__NM.length;i++ ){r.push(g,this.__NM[i].join(e),l);}
;r.push(k);this.__NL.innerHTML=r.join(d);this.__NL.scrollTop=0;}
,__NJ:null,__NK:null,__NL:null,__NM:null},destruct:function(){this.__NL=this.__NM=null;}
});}
)();
