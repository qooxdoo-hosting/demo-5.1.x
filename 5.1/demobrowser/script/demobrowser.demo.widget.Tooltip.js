...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.72fa6c870f3f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__Pc:4,__Pd:0,add:function(B){this.container.add(B,{row:Math.floor(this.__Pd/this.__Pc),column:this.__Pd%this.__Pc});this.__Pd+=1;}
