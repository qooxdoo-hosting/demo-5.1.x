...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Dynamic.bed505434755.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
});var t=this;var s={bindItem:function(x,w,y){x.bindDefaultProperties(w,y);x.bindProperty(b,a,{converter:function(z,A,D,B){var C=B.isOpen();if(C&&!z.getLoaded()){z.setLoaded(true);qx.event.Timer.once(function(){r.setAutoScrollIntoView(false);z.getChildren().removeAll();this.createRandomData(z);r.setAutoScrollIntoView(true);}
,t,1000);}
;return C;}
},w,y);}
};r.setDelegate(s);}
