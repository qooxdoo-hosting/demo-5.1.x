...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.257b5fb53abd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__GW].values;var bo=this.__GS[this.__GW];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__GX){bn.shift();}
...
;this.__GU.setRed(bx);this.__GU.setGreen(bw);this.__GU.setBlue(bv);this.__GT.open();}
,_onColorSelectorOk:function(){var by=this.__GU;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__GT.close();}
,_onColorSelectorCancel:function(){this.__GT.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__GT){this.__GT.destroy();this.__GU.destroy();this.__GV.destroy();}
;this._tables=this.__GS=null;}
});}
)();
...
,setValue:function(da){var cY;if(da==null){this.__nK=true;cY=[255,255,255];}
else {cY=qx.util.ColorUtil.stringToRgb(da);this.__nK=false;}
;this.__wG=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__wG=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__nK?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__nK=true;this.__wG=true;this.setRed(255);this.setGreen(255);this.__wG=false;this.setBlue(255);}
,__nM:function(){if(!this.__wG){this.__nK=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dc,db){if(this.__wA===null){this.__wA=bU;}
;if(this.__wA!==cK){this.getChildControl(m).setValue(dc);}
;if(this.__wA!==n){this._setHexFromRgb();}
;switch(this.__wA){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__nM();if(this.__wA===bU){this.__wA=null;}
;}
,_applyGreen:function(de,dd){if(this.__wA===null){this.__wA=cq;}
;if(this.__wA!==cK){this.getChildControl(O).setValue(de);}
;if(this.__wA!==n){this._setHexFromRgb();}
;switch(this.__wA){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__nM();if(this.__wA===cq){this.__wA=null;}
;}
,_applyBlue:function(dg,df){if(this.__wA===null){this.__wA=d;}
;if(this.__wA!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__wA!==n){this._setHexFromRgb();}
;switch(this.__wA){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__nM();if(this.__wA===d){this.__wA=null;}
;}
,_applyHue:function(di,dh){if(this.__wA===null){this.__wA=cr;}
;if(this.__wA!==F){this.getChildControl(cu).setValue(di);}
;if(this.__wA!==R){if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomLeft(Math.round(di/1.40625)+this.getChildControl(cc).getPaddingLeft());}
else {this.getChildControl(V).setLayoutProperties({left:Math.round(di/1.40625)});}
;}
;switch(this.__wA){case F:case R:case cr:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__wA===cr){this.__wA=null;}
;}
,_applySaturation:function(dk,dj){if(this.__wA===null){this.__wA=s;}
;if(this.__wA!==F){this.getChildControl(cx).setValue(dk);}
;if(this.__wA!==R){this._setBrightnessGradiant();if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomTop(256-Math.round(dk*2.56)+this.getChildControl(cc).getPaddingTop());}
else {this.getChildControl(V).setLayoutProperties({top:256-Math.round(dk*2.56)});}
;}
;switch(this.__wA){case F:case R:case s:this._setRgbFromHue();};if(this.__wA===s){this.__wA=null;}
;}
,_applyBrightness:function(dn,dm){if(this.__wA===null){this.__wA=c;}
;if(this.__wA!==F){this.getChildControl(bT).setValue(dn);}
;if(this.__wA!==P){var dl=256-Math.round(dn*2.56);if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dl+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cM).setLayoutProperties({top:dl});}
;}
;switch(this.__wA){case F:case P:case c:this._setRgbFromHue();};if(this.__wA===c){this.__wA=null;}
;}
,_onBrightnessHandlePointerDown:function(e){this.getChildControl(cM).capture();this.__wC=cM;var dr=this.getChildControl(cf).getContentLocation();var dq=this.getChildControl(cM).getContentLocation();var dp=this.getChildControl(cf).getBounds();this.__wD=dr.top+(e.getDocumentTop()-dq.top)-dp.top;e.stopPropagation();}
,_onBrightnessHandlePointerUp:function(e){this.getChildControl(cM).releaseCapture();this.__wC=null;}
,_onBrightnessHandlePointerMove:function(e){if(this.__wC===cM){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldPointerDown:function(e){var location=this.getChildControl(cf).getContentLocation();var ds=this.getChildControl(cM).getBounds();this.__wD=location.top+(ds.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cM).capture();this.__wC=cM;}
...
,_setBrightnessOnFieldEvent:function(e){var dt=qx.lang.Number.limit(e.getDocumentTop()-this.__wD,0,256);this.__wA=P;if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dt);}
else {this.getChildControl(cM).setLayoutProperties({top:dt});}
;this.setBrightness(100-Math.round(dt/2.56));this.__wA=null;}
,_onHueSaturationHandlePointerUp:function(e){if(this.__wC){e.stopPropagation();this.getChildControl(V).releaseCapture();this.__wC=null;}
;}
,_onHueSaturationHandlePointerMove:function(e){if(this.__wC===V){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldPointerDown:function(e){var location=this.getChildControl(ca).getContentLocation();var du=this.getChildControl(V).getBounds();var dv=this.getChildControl(ca).getBounds();this.__wE=location.top+(du.height/2)-dv.top;this.__wF=location.left+(du.width/2)-dv.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(V).capture();this.__wC=V;}
...
,_setHueSaturationOnFieldEvent:function(e){var dy=qx.lang.Number.limit(e.getDocumentTop()-this.__wE,0,256);var dx=qx.lang.Number.limit(e.getDocumentLeft()-this.__wF,0,256);this.getChildControl(V).setDomPosition(dx,dy);this.__wA=R;this.setSaturation(100-Math.round(dy/2.56));this.setHue(Math.round(dx*1.40625));this.__wA=null;}
,_setRedFromSpinner:function(){if(this.__wA!==null){return;}
;this.__wA=cK;this.setRed(this.getChildControl(m).getValue());this.__wA=null;}
,_setGreenFromSpinner:function(){if(this.__wA!==null){return;}
;this.__wA=cK;this.setGreen(this.getChildControl(O).getValue());this.__wA=null;}
,_setBlueFromSpinner:function(){if(this.__wA!==null){return;}
;this.__wA=cK;this.setBlue(this.getChildControl(cG).getValue());this.__wA=null;}
,_setHueFromSpinner:function(){if(this.__wA!==null){return;}
;this.__wA=F;this.setHue(this.getChildControl(cu).getValue());this.__wA=null;}
,_setSaturationFromSpinner:function(){if(this.__wA!==null){return;}
;this.__wA=F;this.setSaturation(this.getChildControl(cx).getValue());this.__wA=null;}
,_setBrightnessFromSpinner:function(){if(this.__wA!==null){return;}
;this.__wA=F;this.setBrightness(this.getChildControl(bT).getValue());this.__wA=null;}
...
;this.__wA=n;this.setRed(dz[0]);this.setGreen(dz[1]);this.setBlue(dz[2]);this.__wA=null;}
...
,_setHueFromRgb:function(){switch(this.__wA){case F:case R:case P:break;default:var dF=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dF[0]);this.setSaturation(dF[1]);this.setBrightness(dF[2]);};}
,_setRgbFromHue:function(){switch(this.__wA){case cK:case n:break;default:var dG=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dG[0]);this.setGreen(dG[1]);this.setBlue(dG[2]);};}
