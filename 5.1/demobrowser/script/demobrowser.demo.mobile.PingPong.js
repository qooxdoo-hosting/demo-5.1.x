...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.5f36153d5d6e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__Oc=this.__Og(L);U.add(this.__Oc);var Q=this.__Og(A);U.add(Q);this.__NS=this.__Oh(L);this.__Oc.add(this.__NS);this.__Oc.addListener(M,qx.lang.Function.bind(this.__pL,this),this);this.__NR=this.__Oh(A);Q.add(this.__NR);Q.addListener(M,qx.lang.Function.bind(this.__pL,this),this);this.__NT=this.__Oi();U.add(this.__NT);this.__Oa=this.__Oj();this.__Oc.add(this.__Oa);this.__Ob=this.__Oj();Q.add(this.__Ob);this.__NY=[0,0];this.__Od();}
,__Od:function(){this.__NT.setStyles({"left":k,"top":k});this.__NU=new qx.event.Timer(40);this.__NU.addListener(n,function(){var x=(parseInt(this.__NT.getStyle(L))+this.__NV*this.__NW);var y=(parseInt(this.__NT.getStyle(z))+this.__NV*this.__NX);this.__NT.setStyle(L,x+c);this.__NT.setStyle(z,y+c);this.__Of();}
,this);this.__NU.start();}
,__Oe:function(V){this.__NU.stop();this.__NU.dispose();this.__NV=5;this.__NY[V]=this.__NY[V]+1;this.__Oa.setAttribute(w,this.__NY[0]);this.__Ob.setAttribute(w,this.__NY[1]);this.__Od();}
,__Of:function(){var X=this.getBoundsFor(this.__NT);if(X.top<=0){this.__NX=1;}
;if(X.bottom>=window.innerHeight-5){this.__NX=-1;}
;if(X.left<=0||X.right>=window.innerWidth){this.__Oe(X.left<=0?1:0);}
;var Y=this.getBoundsFor(this.__NS);if(X.left<=Y.right&&X.bottom>=Y.top&&X.top<=Y.bottom){this.__NW=1;this.__NV=Math.min(this.__NV+1,20);}
;var W=this.getBoundsFor(this.__NR);if(X.right>=W.left&&X.bottom>=W.top&&X.top<=W.bottom){this.__NW=-1;this.__NV=Math.min(this.__NV+1,20);}
;}
,__pL:function(e){var ba;if(qx.dom.Hierarchy.contains(this.__Oc.getDomElement(),e.getTarget())){ba=this.__NS;}
else {ba=this.__NR;}
...
,__Og:function(bd){var bc={"width":C,"height":h,"position":N,"backgroundColor":a};if(bd==L){bc[J]=u;}
else {bc[L]=C;bc[d]=u;}
;return new qx.html.Element(g,bc);}
,__Oh:function(bf){var be={"width":l,"height":t,"top":t,"position":N,"backgroundColor":K};be[bf]=F;return new qx.html.Element(g,be);}
,__Oi:function(){var bg={"width":F,"height":F,"position":N,"backgroundColor":K,"userSelect":I};return new qx.html.Element(g,bg);}
,__Oj:function(){var bh={"width":h,"height":h,"textAlign":r,"fontSize":H,"color":b,"fontFamily":B};var bi=new qx.html.Element(g,bh);bi.setAttribute(w,j);return bi;}
}});}
)();
