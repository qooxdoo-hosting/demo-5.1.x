...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.73c3b93d4646.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this._storeModel=qx.util.Function.debounce(this.__Ag.bind(this),qx.data.store.Offline.STORE_MODEL_DELAY);this._marshaler=new qx.data.marshal.Json(i);this._key=j;this._initializeModel();}
,properties:{model:{nullable:true,event:d,apply:g}},statics:{STORE_MODEL_DELAY:400},members:{_storage:null,__Af:null,__Ag:function(){var k=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,k);}
,_applyModel:function(m,l){if(l){l.removeListenerById(this.__Af);l.dispose();this.__Af=null;}
;if(m){this.__Af=m.addListener(f,this._storeModel,this);this._storeModel();}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__Ah:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__Ai:null,__Aj:null,getLocal:function(){if(this.__Ai){return this.__Ai;}
;return this.__Ai=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__Aj){return this.__Aj;}
;return this.__Aj=new qx.bom.storage.Web(b);}
},construct:function(g){this.__nN=g;}
,members:{__nN:null,getStorage:function(){return window[this.__nN+c];}
,getLength:function(){return this.getStorage(this.__nN).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__nN).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__nN).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__nN).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__nN);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__nN).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__Ai:null,__Aj:null,__cl:0,getLocal:function(){if(this.__Ai){return this.__Ai;}
;return this.__Ai=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__Aj){return this.__Aj;}
;return this.__Aj=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__Ak=document.createElement(f);this.__Ak.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__Ak);this.__Ak.addBehavior(j);this.__Al=m;this.__Ak.load(this.__Al);this.__fw={};this.__Am={};var l=this.__Ak.getAttribute(d+qx.bom.storage.UserData.__cl);while(l!=undefined){l=qx.lang.Json.parse(l);this.__fw[l.key]=l.value;this.__Am[l.key]=d+qx.bom.storage.UserData.__cl;qx.bom.storage.UserData.__cl++ ;l=this.__Ak.getAttribute(d+qx.bom.storage.UserData.__cl);}
;}
,members:{__Ak:null,__Al:h,__fw:null,__Am:null,getStorage:function(){return this.__fw;}
,getLength:function(){return Object.keys(this.__fw).length;}
,setItem:function(n,p){if(this.__Am[n]){var o=this.__Am[n];}
else {var o=d+qx.bom.storage.UserData.__cl;qx.bom.storage.UserData.__cl++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__Ak.setAttribute(o,q);this.__Ak.save(this.__Al);this.__fw[n]=p;this.__Am[n]=o;}
,getItem:function(r){return this.__fw[r]||null;}
,removeItem:function(v){var u=this.__Am[v];if(u==undefined){return;}
;this.__Ak.removeAttribute(u);qx.bom.storage.UserData.__cl-- ;delete this.__fw[v];delete this.__Am[v];var t=d+qx.bom.storage.UserData.__cl;if(this.__Ak.getAttribute(t)){var w=this.__Ak.getAttribute(d+qx.bom.storage.UserData.__cl);this.__Ak.removeAttribute(t);this.__Ak.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__Am[s]=u;}
;this.__Ak.save(this.__Al);}
,clear:function(){for(var x in this.__Am){this.__Ak.removeAttribute(this.__Am[x]);}
;this.__Ak.save(this.__Al);this.__fw={};this.__Am={};}
,getKey:function(y){return Object.keys(this.__fw)[y];}
,forEach:function(z,B){var length=this.getLength();for(var i=0;i<length;i++ ){var A=this.getKey(i);z.call(B,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__Ai:null,__Aj:null,getLocal:function(){if(this.__Ai){return this.__Ai;}
;return this.__Ai=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__Aj){return this.__Aj;}
;return this.__Aj=new qx.bom.storage.Memory();}
},construct:function(){this.__fw={};}
,members:{__fw:null,getStorage:function(){return this.__fw;}
,getLength:function(){return Object.keys(this.__fw).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__fw[b]=c;}
,getItem:function(e){var d=this.__fw[e];if(qx.lang.Type.isString(d)){d=qx.lang.Json.parse(d);}
;return d;}
,removeItem:function(f){delete this.__fw[f];}
,clear:function(){this.__fw={};}
,getKey:function(h){var g=Object.keys(this.__fw);return g[h];}
