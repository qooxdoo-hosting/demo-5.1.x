...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Selection.d117f4df201f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__xq=[];this.__xr=[];this._isHorizontal=(w||c)==c;}
,properties:{defaultLineColor:{init:h,check:s,themeable:true},defaultLineSize:{init:1,check:t,themeable:true}},members:{__xq:null,__xr:null,isHorizontal:function(){return this._isHorizontal;}
...
;this.__xq[B]=A;if(this.__xs(B)){this.updateLayerData();}
;}
...
;this.__xr[C]=D;if(this.__xs(C)){this.updateLayerData();}
;}
,__xs:function(E){if(this._isHorizontal){var I=this.getFirstColumn();var G=I+this.getColumnSizes().length-1;return E>=I&&E<=G;}
else {var H=this.getFirstRow();var F=H+this.getRowSizes().length-1;return E>=H&&E<=F;}
;}
,getLineSize:function(J){return this.__xr[J]||this.getDefaultLineSize();}
,getLineColor:function(K){return this.__xq[K]||this.getDefaultLineColor();}
,__xt:function(P,M,O){var top=0;var L,N;for(var y=0;y<O.length-1;y++ ){L=this.getLineColor(M+y);N=this.getLineSize(M+y);top+=O[y];P.push(m,g,f+N+q,j,d,top-((N>1)?Math.floor(N/2):1),q,b,L,n,a);}
;}
,__xu:function(T,Q,S){var V=0;var R,U;for(var x=0;x<S.length-1;x++ ){R=this.getLineColor(Q+x);U=this.getLineSize(Q+x);V+=S[x];T.push(m,g,k+U+q,l,u,p,V-((U>1)?Math.floor(U/2):1),q,b,R,n,a);}
;}
,_fullUpdate:function(ba,bb,X,W){var Y=[];if(this._isHorizontal){this.__xt(Y,ba,X);}
else {this.__xu(Y,bb,W);}
...
,getCssClasses:function(br,bp){var bq=this.__ds.getCssClass(this.__tI)||t;return v+bq;}
,__tL:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__tI==bt){return;}
;this.__tI=bt;var bv=this.__jB[this.__tI];if(!bv){this.__tM();this.__tN(bs);this.__tO(bs);this.__tP();this.__jB[this.__tI]=1;}
;this.__tQ();}
...
;}
;this.__tJ=false;}
,__tO:function(){var bD=qx.lang.Object.getValues(this.__tD).join(I);this.__ds.computeClassForStyles(this.__tI,bD);}
...
},destruct:function(){this.__ds=this.__tC=this.__tD=this.__tE=this.__tF=this.__jB=this.__tG=this.__tH=null;}
});}
)();
