...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.9fa3cacb081d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__mv=document||window.document;this.__BX();var self=this;qx.bom.Event.addNativeListener(this.__mv,this.__hl,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__mv:null,__FL:null,__FM:null,__hl:null,__BX:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__mv[m]!=undefined){this.__FL=m;this.__hl=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__mv[m]!=undefined){this.__FM=m;break;}
;}
;if(this.__FL==null){this.__FL=k;this.__hl=c;}
;if(this.__FM==null){this.__FM=b;}
;}
,isHidden:function(){return !!this.__mv[this.__FL];}
,getVisibilityState:function(){return this.__mv[this.__FM]||d;}
}});}
)();
