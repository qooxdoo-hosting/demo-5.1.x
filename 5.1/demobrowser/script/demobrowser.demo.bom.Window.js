...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.b8afed83749b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="Open Native Modal Window",c="demobrowser.demo.bom.Window",d="Modal Window closed?",f="http://sourceforge.net",g="window1",h="window3",i="http://slashdot.org",j="Window closed?",k="http://qooxdoo.org",l="demobrowser/demo/html/ModalWindow.html",m="#eee",n="Open Faked Native Modal Window",o="window2",p="tap",q="button";qx.Class.define(c,{extend:qx.application.Native,members:{__sP:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__sP=[k,f,i,r.toUri(l)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,p,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__sP[0],g,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,b);document.body.appendChild(s);qx.event.Registration.addListener(s,p,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__sP[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,p,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(m);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__sP[0],h,A,true,false);}
,this);}
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__lQ:null,__Hs:null,__de:null,__Ht:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__Hu:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Hv:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__Hw(H,E&&A);if(E){if(this.__Hv()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__de==null){this.__de=new qx.event.Timer(500);this.__de.addListener(f,this.__Hx,this);}
;this.__Hs=window.open(z,name,G);this.__de.restart();C=this.__Hs;}
;}
...
;return C;}
,__Hw:function(K,O){var M;var J;var N=[];if(O&&this.__Hv()){for(var L in K){if(qx.bom.Window.__Ht[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__Ht[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__Hu[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__Hx:function(){if(this.isClosed(this.__Hs)){this.getBlocker().unblock();this.__de.stop();}
;}
,getBlocker:function(){if(this.__lQ==null){this.__lQ=new qx.bom.Blocker;}
;return this.__lQ;}
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__ek();}
,members:{__Hy:null,__wO:null,__Hz:null,__HA:false,__HB:10000,__HC:0,__HD:f,block:function(r){if(!this.__HA){this.__Hz=r;var q=this.__HG();this.__HH(q);this.__HA=true;}
;}
,unblock:function(){if(this.__HA){this.__HI();this.__HA=false;}
;}
,isBlocked:function(){return this.__HA;}
,getBlockerElement:function(){return this.__wO;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__wO,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__wO,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__wO,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__wO);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__wO,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__wO,h);}
,__ek:function(){this.__HE();if((qx.core.Environment.get(j)==b)){this.__HF();}
;qx.event.Registration.addListener(window,a,this.__zJ,this);}
,__HE:function(){this.__wO=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__wO,{display:d,opacity:this.__HC,backgroundColor:this.__HD});this.setBlockerZIndex(this.__HB);}
,__HF:function(){this.__Hy=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__Hy,l,false);qx.bom.element.Attribute.set(this.__Hy,i,n);qx.bom.element.Style.setStyles(this.__Hy,{display:d,opacity:this.__HC});}
,__HG:function(){var v={position:p};if(this.__HK()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__Hz)+g;v.height=qx.bom.element.Dimension.getHeight(this.__Hz)+g;v.left=qx.bom.element.Location.getLeft(this.__Hz)+g;v.top=qx.bom.element.Location.getTop(this.__Hz)+g;}
;return v;}
,__HH:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__wO,w);qx.dom.Element.insertEnd(this.__wO,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Hy,w);qx.dom.Element.insertEnd(this.__Hy,document.body);}
;}
,__HI:function(){qx.dom.Element.remove(this.__wO);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__Hy);}
;}
,__zJ:function(e){if(this.__HK()){this.__HJ({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__HJ(y);}
,this,0);}
;}
,__HJ:function(z){qx.bom.element.Style.setStyles(this.__wO,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__Hy,z);}
;}
,__HK:function(){return (this.__Hz==null||qx.dom.Node.isWindow(this.__Hz)||qx.dom.Node.isDocument(this.__Hz));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__zJ,this);this.__Hy=this.__wO=this.__Hz=null;}
});}
)();
