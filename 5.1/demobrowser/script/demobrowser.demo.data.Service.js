...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Service.cfcdc9126273.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="qx.core.Object",c="qx.data.controller.Object",d="get",e="[",f="reset",g="_applyModel",h="last";qx.Class.define(c,{extend:qx.core.Object,construct:function(j){qx.core.Object.call(this);this.__bc={};this.__hc=[];if(j!=null){this.setModel(j);}
;}
,properties:{model:{check:b,event:a,apply:g,nullable:true,dereference:true}},members:{__hc:null,__bc:null,_applyModel:function(o,l){for(var i=0;i<this.__hc.length;i++ ){var t=this.__hc[i][0];var q=this.__hc[i][1];var n=this.__hc[i][2];var r=this.__hc[i][3];var p=this.__hc[i][4];var m=this.__hc[i][5];if(l!=undefined&&!l.isDisposed()){this.__Eo(t,q,n,l);}
;if(o!=undefined){this.__En(t,q,n,r,p,m);}
...
;}
;}
,addTarget:function(z,w,u,x,y,v){this.__hc.push([z,w,u,x,y,v]);this.__En(z,w,u,x,y,v);}
,__En:function(F,D,B,G,E,A){if(this.getModel()==null){return;}
...
,removeTarget:function(K,J,L){this.__Eo(K,J,L,this.getModel());for(var i=0;i<this.__hc.length;i++ ){if(this.__hc[i][0]==K&&this.__hc[i][1]==J&&this.__hc[i][2]==L){this.__hc.splice(i,1);}
;}
;}
,__Eo:function(R,O,N,M){if(!(R instanceof qx.core.Object)){return;}
