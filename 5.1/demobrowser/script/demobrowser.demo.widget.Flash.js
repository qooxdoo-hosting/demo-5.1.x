...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.45b3fdfb9740.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="Flash Player Version",c="__Cz",d="right",f="qooxdoo is the best!",g="Message from Flash:",h="__OQ",i="execute",j="Simple demo with FlashVars",k="bgcolor",l="__cz",m="demobrowser.demo.widget.Flash",n="demobrowser/demo/flash/TestFlash.swf",o="1) no pop-up or advertising blocker is activated.\n",p="Send to Flash",q="demobrowser/demo/flash/FlashVersion.swf",r="No message.",s="Flash:",t="__OO",u="<b>qooxdoo:</b>",v="demobrowser.demo.widget.Flash.sendMessage",w="demobrowser.demo.widget.Flash.flashReady",x="Couldn't connect to Flash Player! Please make sure that:\n",y="__OP",z="demobrowser/demo/flash/fo_tester.swf",A="this is passed in via FlashVars",B="Two way communication (ActionScript <-> JavaScript)",C="Message to Flash:",D="Show Flash Player version",E="noscale",F="#FF6600";qx.Class.define(m,{extend:qx.application.Standalone,members:{__cz:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(j);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(B);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cz=this.createWindow();G.add(this.__cz,{top:20,left:20});}
,createWindow:function(){var K=new qx.ui.window.Window(b).set({width:300,height:200,contentPadding:[0,0,0,0]});K.setLayout(new qx.ui.layout.Canvas());K.add(new qx.ui.embed.Flash(q),{edge:0});return K;}
...
,__Cz:null,__OO:null,__OP:null,__OQ:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(u).set({rich:true}));Q.add(new qx.ui.basic.Label(g));this.__OO=new qx.ui.form.TextArea(r);this.__OO.setEnabled(false);Q.add(this.__OO,{flex:1});Q.add(new qx.ui.basic.Label(C));this.__OP=new qx.ui.form.TextArea(f);Q.add(this.__OP,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,d));this.__OQ=new qx.ui.form.Button(p);this.__OQ.setEnabled(false);this.__OQ.addListener(i,function(e){this.__Cz.getFlashElement().sendMessage(this.__OP.getValue());}
,this);S.add(this.__OQ);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(s).set({rich:true}));this.__Cz=new qx.ui.embed.Flash(n);this.__Cz.setVariables({init:w});P.add(this.__Cz,{flex:1});return R;}
,sendMessage:function(T){this.__OO.setValue(T);}
,initFlash:function(){if(this.__Cz.getFlashElement().setup){this.__Cz.getFlashElement().setup(v);this.__OQ.setEnabled(true);}
else {alert(x+o+a);}
;}
},statics:{__OR:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__OR=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__OR.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__OR.initFlash();}
},destruct:function(){this._disposeObjects(t,y,h,c,l);}
});}
)();
...
(function(){var a="bottom",b="button",c="qx.event.type.Data",d="lastTab",f="barRight",g="__ty",h="beforeChangeSelection",j="qx.debug",k="horizontal",m="changeSelection",n="bar",o="close-button",p="Index should be less than : ",q="tabview",r="vertical",s="page",t="Incompatible child for TabView: ",u="close",v="_applyBarPosition",w="barLeft",x="top",y="right",z="qx.ui.tabview.TabView",A="barTop",B="barBottom",C="pane",D="left",E="firstTab";qx.Class.define(z,{extend:qx.ui.core.Widget,implement:qx.ui.core.ISingleSelection,include:[qx.ui.core.MContentPadding],construct:function(G){qx.ui.core.Widget.call(this);this.__AB={top:A,right:f,bottom:B,left:w};this._createChildControl(n);this._createChildControl(C);var F=this.__ty=new qx.ui.form.RadioGroup;F.setWrap(false);F.addListener(m,this._onChangeSelection,this);if(G!=null){this.setBarPosition(G);}
else {this.initBarPosition();}
;}
,events:{"changeSelection":c},properties:{appearance:{refine:true,init:q},barPosition:{check:[D,y,x,a],init:x,apply:v}},members:{__ty:null,_createChildControlImpl:function(J,I){var H;switch(J){case n:H=new qx.ui.container.SlideBar();H.setZIndex(10);this._add(H);break;case C:H=new qx.ui.container.Stack;H.setZIndex(5);this._add(H,{flex:1});break;};return H||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,J);}
...
;}
;var K=O.getButton();var L=this.getChildControl(n);var N=this.getChildControl(C);O.exclude();L.add(K);N.add(O);this.__ty.add(K);O.addState(this.__AB[this.getBarPosition()]);O.addState(d);var M=this.getChildren();if(M[0]==O){O.addState(E);}
...
;var R=U.getButton();var Q=this.getChildControl(n);var T=this.getChildControl(C);U.exclude();Q.addAt(R,P);T.addAt(U,P);this.__ty.add(R);U.addState(this.__AB[this.getBarPosition()]);S=this.getChildren();if(P==S.length-1){U.addState(d);}
...
;}
;W.remove(X);ba.remove(Y);this.__ty.remove(X);Y.removeState(this.__AB[this.getBarPosition()]);if(Y.hasState(E)){Y.removeState(E);if(bb[0]){bb[0].addState(E);}
;}
...
,__AB:null,_applyBarPosition:function(bg,bi){var bd=this.getChildControl(n);var bj=this.getChildControl(C);var bl=bg==D||bg==y;var bm=bg==y||bg==a;var bk=bl?qx.ui.layout.HBox:qx.ui.layout.VBox;var bn=this._getLayout();if(bn&&bn instanceof bk){}
else {this._setLayout(bn=new bk);}
;bn.setReversed(bm);bd.setOrientation(bl?r:k);var bh=this.getChildren();var i,l;if(bi){var bf=this.__AB[bi];bd.removeState(bf);bj.removeState(bf);for(i=0,l=bh.length;i<l;i++ ){bh[i].removeState(bf);}
;}
;if(bg){var be=this.__AB[bg];bd.addState(be);bj.addState(be);for(i=0,l=bh.length;i<l;i++ ){bh[i].addState(be);}
;}
;}
,getSelection:function(){var bo=this.__ty.getSelection();var bp=[];for(var i=0;i<bo.length;i++ ){bp.push(bo[i].getUserData(s));}
;return bp;}
,setSelection:function(br){var bq=[];for(var i=0;i<br.length;i++ ){bq.push(br[i].getChildControl(b));}
;this.__ty.setSelection(bq);}
,resetSelection:function(){this.__ty.resetSelection();}
,isSelected:function(bs){var bt=bs.getChildControl(b);return this.__ty.isSelected(bt);}
,isSelectionEmpty:function(){return this.__ty.isSelectionEmpty();}
,getSelectables:function(bv){var bu=this.__ty.getSelectables(bv);var bw=[];for(var i=0;i<bu.length;i++ ){bw.push(bu[i].getUserData(s));}
;return bw;}
...
},destruct:function(){this._disposeObjects(g);this.__AB=null;}
});}
)();
...
,__og:function(e){var m=e.getOldData()[0];var n=e.getData()[0];if(m){if(this.isDynamic()){m.exclude();}
else {m.hide();}
;}
;if(n){n.show();}
;}
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__Cu){this.__Cu=new Date().getTime();}
;var bp=new Date().getTime()-this.__Cu;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__Cu=null;}
;}
else {this.fireEvent(p);this.__Cu=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__Cv(c,bB);}
,_applyScale:function(bD,bC){this.__Cv(h,bD);}
,_applyWmode:function(bF,bE){this.__Cv(m,bF);}
,_applyPlay:function(bH,bG){this.__Cv(I,bH);}
,_applyLoop:function(bJ,bI){this.__Cv(s,bJ);}
,_applyMenu:function(bL,bK){this.__Cv(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__Cv(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__Cv(z,bP);}
,__Cv:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__Cw={};this.__Cx={};this.__Cy={};}
,members:{__Cw:null,__Cy:null,__Cx:null,__Cz:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__Cz=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__Cx,this.__Cw);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__Cz){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__Cz){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__Cx;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__Cz){throw new Error(d);}
;this.__Cx=t;}
,getAttributes:function(){return this.__Cy;}
...
else if(this.__Cz){throw new Error(j);}
;if(v===null||v===undefined){delete this.__Cy[u];}
else {this.__Cy[u]=v;}
;}
,getParams:function(){return this.__Cw;}
...
;}
;}
;if(this.__Cz){throw new Error(l);}
;if(x===null||x===undefined){delete this.__Cw[w];}
else {this.__Cw[w]=x;}
;}
,getFlashElement:function(){return this.__Cz;}
},destruct:function(){if(this.__Cz){qx.bom.Flash.destroy(this.__Cz);}
;this.__Cw=this.__Cx=this.__Cy=null;}
});}
)();
...
;}
;}
;var O=this.__CF(P,R,Q,M);this._flashObjects[R.id]=O;return O;}
,destroy:function(T,S){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){T=this.__CA(T);if(T.readyState==4){this.__CB(T);}
else {if(!S){S=window;}
;qx.bom.Event.addNativeListener(S,p,function(){qx.bom.Flash.__CB(T);}
);}
;}
else {T=this.__CA(T);if(T.parentNode){T.parentNode.removeChild(T);}
;delete this._flashObjects[T.id];}
;}
,__CA:function(U){if(!U){throw new Error(z);}
;if(U.tagName.toLowerCase()!==L){U=U.firstChild;}
;if(!U||U.tagName.toLowerCase()!==L){throw new Error(A);}
;return U;}
,__CB:qx.core.Environment.select(D,{"mshtml":qx.event.GlobalError.observeMethod(function(V){for(var i in V){if(typeof V[i]==b){V[i]=null;}
;}
;if(V.parentNode){V.parentNode.removeChild(V);}
;delete this._flashObjects[V.id];}
),"default":null}),__CC:qx.event.GlobalError.observeMethod(function(){for(var W in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[W]);}
;window.__CD=function(){}
;window.__CE=function(){}
;qx.bom.Event.removeNativeListener(window,F,qx.bom.Flash.__CC);}
),__CF:function(bb,bd,bc,X){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){bc.movie=bd.data;delete bd.data;delete bd.classid;var Y=u;for(var name in bc){Y+=m+name+J+bc[name]+E;}
...
},defer:function(bf){if(qx.core.Environment.get(D)==v){qx.bom.Event.addNativeListener(window,F,bf.__CC);}
;}
});}
)();
